          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="p-2 border border-gray-700 w-10 bg-gray-200 align-middle">image_ideas<br /><strong>id</strong></th>
                <th className="p-2 border border-gray-700 bg-yellow-100 align-middle">image_ideas<br /><strong>rel_image_batches_id</strong></th>
                <th className="p-2 border border-gray-700 bg-yellow-100 align-middle">image_idea_batches<br /><strong>created_at</strong></th>
                <th className="p-2 border border-gray-700 bg-yellow-100 align-middle">image_idea_batches<br /><strong>note1</strong></th>
                ...
                <th className="p-2 border border-gray-700 bg-gray-200 align-middle">image_ideas<br /><strong>img_file_url1</strong></th>
                <th className="p-2 border border-gray-700 bg-gray-200 align-middle">image_ideas<br /><strong>img_file_extension</strong></th>
                <th className="p-2 border border-gray-700 bg-gray-200 align-middle">image_ideas<br /><strong>img_file_size</strong></th>
                <th className="p-2 border border-gray-700 bg-gray-200 align-middle">image_ideas<br /><strong>width</strong></th>
                <th className="p-2 border border-gray-700 bg-gray-200 align-middle">image_ideas<br /><strong>height</strong></th>
                <th className="p-2 border border-gray-700 bg-gray-200 align-middle">image_ideas<br /><strong>folder_path1</strong></th>
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">image_ideas<br /><strong>e_img_zpf_code</strong></th>
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">image_ideas<br /><strong>e_width</strong></th>
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">image_ideas<br /><strong>e_height</strong></th>
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">image_ideas<br /><strong>e_associated_text_content_on_page1</strong></th>
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">image_ideas<br /><strong>e_file_name</strong></th>
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">image_ideas<br /><strong>e_more_instructions1</strong></th>
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">image_ideas<br /><strong>e_prompt1</strong></th>
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">image_ideas<br /><strong>e_ai_tool1</strong></th>
