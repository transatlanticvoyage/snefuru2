          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">width_desired1</th>
                <th className="p-2 border border-gray-700 bg-pink-200 align-middle">height_desired1</th>
