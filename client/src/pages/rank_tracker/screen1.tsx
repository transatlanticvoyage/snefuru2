...
const dummyData = [
  ...
  { url: 'aucklandplumbersgroup.co.nz', change: 0, high: 1, low: 1, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'augustaconcreteco.com', change: 0, high: 1, low: 1, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'augustamoldcontrol.com', change: 0, high: 2, low: 2, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'bentonvilleconcrete.com', change: 0, high: 1, low: 1, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'cleaningpro.co.nz', change: 0, high: 1, low: 1, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'columbiaroofingexperts.com', change: 2, high: 58, low: 58, keywords: 1, movement: 'up', expandedView: false, keywordData: [] },
  { url: 'concretedrivewayauckland.co.nz', change: -1, high: 2, low: 2, keywords: 1, movement: 'down', expandedView: false, keywordData: [] },
  { url: 'concretespecialistsdunedin.com', change: 0, high: 2, low: 2, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'deanconsultgroup.com', change: 0, high: 0, low: 0, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'deckbuildersgrandrapids.com', change: 0, high: 11, low: 11, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'drywallranklin.com', change: 0, high: 2, low: 2, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'drywallmurfreesboro.com', change: 0, high: 1, low: 1, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'electrician-islington.com', change: 0, high: 13, low: 13, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
  { url: 'electricianproslansing.com', change: 0, high: 13, low: 13, keywords: 1, movement: 'neutral', expandedView: false, keywordData: [] },
];
